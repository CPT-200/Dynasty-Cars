...
/*				
				if (make.equalsIgnoreCase("All") && model.equalsIgnoreCase("All") &&
						year.equalsIgnoreCase("All") && type.equalsIgnoreCase("All") &&
						color.equalsIgnoreCase("All") && engine.equalsIgnoreCase("All")) {
					...
					if (!type.equalsIgnoreCase("All")) {
						if (type.equalsIgnoreCase("Coupe")) { 
							searchList = (ArrayList<Car>) coupeList.clone();
						} else if (type.equalsIgnoreCase("Sedan")) { 
							searchList = (ArrayList<Car>) sedanList.clone();
						} else if (type.equalsIgnoreCase("Convertible")) { 
							searchList = (ArrayList<Car>) convertibleList.clone();
						} else if (type.equalsIgnoreCase("Hatchback")) { 
							searchList = (ArrayList<Car>) hatchbackList.clone();
						} else if (type.equalsIgnoreCase("Truck")) { 
							searchList = (ArrayList<Car>) truckList.clone();
						} else if (type.equalsIgnoreCase("Wagon")) { 
							searchList = (ArrayList<Car>) wagonList.clone();
						}
					} else {
